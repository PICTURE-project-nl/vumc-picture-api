...
class NeuroDiagnostics:
    ...
    """
    def __init__(self, input_filename, input_segmentation, preprocessing_scheme, input_registration=None):
        ...
        if input_registration:
            self.registration_runner.reg_transform = input_registration
    ...
    def run(self):
        ...
        if not(self.registration_runner.reg_transform):
