...
from nnunet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform, RemoveKeyTransform,  SparsifiedTraining
...
def get_default_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    if params.get("zeros_probability") is not None and params.get("zeros_probability"):
        print('Using SPARSIFIED_TRAINING with zeros_probability: '+str(params.get("zeros_probability")))
        tr_transforms.append(SparsifiedTraining(zeros_probability=params.get("zeros_probability")))
